...
function onScann(qrData) {
  ...
  const formURL = `https://docs.google.com/forms/d/e/1FAIpQLScFcGIl0yXDTynZfGduxke3vUpxAPAupHfwo5hwixlyKkZqvw/viewform?usp=pp_url&entry.913854003=${encodeURIComponent(codigo)}`
